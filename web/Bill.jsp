<%-- 
    Document   : Bill
    Created on : Jun 27, 2019, 10:39:35 PM
    Author     : ayush
--%>
...
<html>
    ...
    <body bgcolor="GreenYellow">
        ...
        <p align="left">
         <a href="successPage.jsp"> Back to Main Menu</a> &emsp;
...
<br/><br/><br/>
<h2> Please check the details below and confirm payment at the end of the page.</h2>
<br/><br/>
...
<%
    ...
    <form action="Payment_confirmation.jsp" >
        <center> <input type="submit" value="Confirm Payment"></center>
